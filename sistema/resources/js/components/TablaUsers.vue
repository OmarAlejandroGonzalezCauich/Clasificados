            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        <i class="fa fa-align-justify"></i> Escritorio Usuarios
...
<script>
    export default {
        ...
        methods : {
            listarUsers (){
                ...
                axios.get('/users').then(function (response) {
                    me.arrayUsers = response.data; //este me. arrayUsers es la que se creo en return 
                })
        ...
        mounted() {
            this.listarUsers(); //esta funcion llama a la funcion methods el que esta arriba
        }
    }
</script>
